...
from atcoder_awarder.libs.visualizer import visualize_ranking, display_member, display_result, AWARD_FORMAT, USER_WITH_HYPERLINK
...
def _(message, say):
    ...
    while running and not_sleep:
        ...
        if (no := Contestant.identify_latest_abc_holding_number()) != Contestant.latest_abc_holding_number:
